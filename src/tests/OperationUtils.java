...
public class OperationUtils {
    ...
    public static CondExpr[] processBMRawConditionExpression(String expression, String[] targetColumns) throws Exception {
        // Sample input
        // String expression = "([columnarTable1.A = 'RandomTextHere'] v [columnarTable1.B > 2]) ^ ([columnarTable1.C = columnarTable1.D])"
        CondExpr[] condExprs;
    ...
    public static CondExpr[] processBMEquiJoinConditionExpression(String expression, Columnarfile innerColumnarFile, Columnarfile outerColumnarFile) {
        CondExpr[] condExprs;
