...
public class Heapfile implements Filetype, GlobalConst {
    ...
    */
    private HFPage _newDatapage(DataPageInfo dpinfop) throws HFException, HFBufMgrException, HFDiskMgrException, IOException {
        Page apage = new Page();
    ...
    */
    private boolean _findDataPage(RID rid, PageId dirPageId, HFPage dirpage, PageId dataPageId, HFPage datapage, RID rpDataPageRid) throws InvalidSlotNumberException, InvalidTupleSizeException, HFException, HFBufMgrException, HFDiskMgrException, Exception {
        ...
        while (currentDirPageId.pid != INVALID_PAGE) {// Start While01
            ...
            if (currentDirPageId.pid != INVALID_PAGE) {
                ...
                if (currentDirPage == null) throw new HFException(null, "pinPage return null page");
            }
    ...
    public RID insertRecord(byte[] recPtr) throws InvalidSlotNumberException, InvalidTupleSizeException, SpaceNotAvailableException, HFException, HFBufMgrException, HFDiskMgrException, IOException {
        ...
        while (found == false) { //Start While01
            ...
            if (found == false) { //Start IF01
                ...
                if (currentDirPage.available_space() >= dpinfo.size) {
                    ...
                    if (currentDataPageRid == null) throw new HFException(null, "no space to insert rec.");
                    ...
                    if (nextDirPageId.pid != INVALID_PAGE) { //Start IF03
                        ...
                        // need check error!
                        if (nextDirPageId == null) throw new HFException(null, "can't new pae");
        ...
        if (currentDataPage == null) throw new HFException(null, "can't find Data page");
    ...
    public boolean deleteRecord(RID rid) throws InvalidSlotNumberException, InvalidTupleSizeException, HFException, HFBufMgrException, HFDiskMgrException, Exception {
        ...
        status = _findDataPage(rid, currentDirPageId, currentDirPage, currentDataPageId, currentDataPage, currentDataPageRid);
    ...
    public void deleteFile() throws InvalidSlotNumberException, FileAlreadyDeletedException, InvalidTupleSizeException, HFBufMgrException, HFDiskMgrException, IOException {
        if (_file_deleted) throw new FileAlreadyDeletedException(null, "file alread deleted");
     ...
     * //   * @see bufmgr.pinPage
     */
    public void pinPage(PageId pageno, Page page, boolean emptyPage) throws HFBufMgrException {
    ...
    public int getRIDPos(RID r) throws InvalidSlotNumberException, InvalidTupleSizeException, HFException, HFDiskMgrException, HFBufMgrException, Exception {
        ...
        while (currentDirPageId.pid != INVALID_PAGE) {
            for (rid = currentDirPage.firstRecord(); rid != null; rid = currentDirPage.nextRecord(rid)) {
                ...
                if (dpinfo.pageId.pid == r.pageNo.pid) {
                    ...
                    HFPage apage = new HFPage();
                    pinPage(dpinfo.pageId, apage, false);
                    int rp = apage.getPositionOfSlot(r);
                    unpinPage(dpinfo.pageId, false);
                    return position + rp;
                }
    ...
    public int positionOfRecord(RID r) throws InvalidSlotNumberException, InvalidTupleSizeException, HFException, HFDiskMgrException, HFBufMgrException, Exception {
