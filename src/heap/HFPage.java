...
public class HFPage extends Page implements ConstSlot, GlobalConst {
  ...
  */
    ...
    public int slotAtRelativePosition(int position) throws IOException {
    ...
    public int getPositionOfSlot(RID rid) throws IOException {
    ...
    public int relativePositionOfSlot(RID rid) throws IOException {
